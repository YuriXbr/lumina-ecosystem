...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the tickle action!')
        .setDescriptionLocalizations(loc('Realize a ação tickle!', '¡Realiza la acción tickle!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to tickle')
                .setDescriptionLocalizations(loc('O usuário para tickle', 'El usuario para tickle'))
                .setRequired(true))
        .setContexts(0, 1, 2),
    ...
    async execute(interaction, t) {
        ...
        const result = await axios.get('https://api.otakugifs.xyz/gif?reaction=tickle&format=gif');
