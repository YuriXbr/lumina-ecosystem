...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the lick action!')
        .setDescriptionLocalizations(loc('Realize a ação lick!', '¡Realiza la acción lick!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to lick')
                .setDescriptionLocalizations(loc('O usuário para lick', 'El usuario para lick'))
                .setRequired(true))
        .setContexts(0, 1, 2),
