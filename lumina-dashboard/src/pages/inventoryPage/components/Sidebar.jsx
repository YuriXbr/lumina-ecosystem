                ...
                <div className="space-y-3">
                    <div className="relative">
                        <input
                            ...
                            placeholder={t("inventory.filterChampions")}
            ...
            <div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                        {rarityOptions
                            .filter(option => t(option.labelKey).toLowerCase().includes(raritySearch.toLowerCase()))
                            .map(option => (
                                <label 
                                    key={option.key} 
                                ...
                                >
                                    ...
                                    />
                                    <span className="text-sm text-gray-700 flex-1">{t(option.labelKey)}</span>
                                </label>
                            ))
                        }
                    </div>
            ...
            {(selectedChampions.length > 0 || selectedRarities.length > 0 || generalSearch || championSearch || raritySearch) && (
                <div className="pt-4 border-t border-gray-200">
                    ...
                    >
                        ...
                        <span>{t("inventory.clearAllFilters")}</span>
                    </button>
                </div>
            )}
        </div>
