...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the bite action!')
        .setDescriptionLocalizations(loc('Realize a ação bite!', '¡Realiza la acción bite!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to bite')
                .setDescriptionLocalizations(loc('O usuário para bite', 'El usuario para bite'))
                .setRequired(true))
        .setContexts(0, 1, 2),
