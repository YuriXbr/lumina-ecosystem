...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the nuzzle action!')
        .setDescriptionLocalizations(loc('Realize a ação nuzzle!', '¡Realiza la acción nuzzle!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to nuzzle')
                .setDescriptionLocalizations(loc('O usuário para nuzzle', 'El usuario para nuzzle'))
                .setRequired(true))
        .setContexts(0, 1, 2),
    ...
    async execute(interaction, t) {
        ...
        const result = await axios.get('https://api.otakugifs.xyz/gif?reaction=nuzzle&format=gif');
