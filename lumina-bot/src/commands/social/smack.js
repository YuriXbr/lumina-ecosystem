...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the smack action!')
        .setDescriptionLocalizations(loc('Realize a ação smack!', '¡Realiza la acción smack!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to smack')
                .setDescriptionLocalizations(loc('O usuário para smack', 'El usuario para smack'))
                .setRequired(true))
        .setContexts(0, 1, 2),
    ...
    async execute(interaction, t) {
        ...
        const result = await axios.get('https://api.otakugifs.xyz/gif?reaction=smack&format=gif');
