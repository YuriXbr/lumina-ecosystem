...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the pat action!')
        .setDescriptionLocalizations(loc('Realize a ação pat!', '¡Realiza la acción pat!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to pat')
                .setDescriptionLocalizations(loc('O usuário para pat', 'El usuario para pat'))
                .setRequired(true))
        .setContexts(0, 1, 2),
