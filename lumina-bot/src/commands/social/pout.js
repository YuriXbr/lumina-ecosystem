...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the pout action!')
        .setDescriptionLocalizations(loc('Realize a ação pout!', '¡Realiza la acción pout!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to pout')
                .setDescriptionLocalizations(loc('O usuário para pout', 'El usuario para pout'))
                .setRequired(true))
        .setContexts(0, 1, 2),
