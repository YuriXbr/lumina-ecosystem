...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the nosebleed action!')
        .setDescriptionLocalizations(loc('Realize a ação nosebleed!', '¡Realiza la acción nosebleed!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to nosebleed')
                .setDescriptionLocalizations(loc('O usuário para nosebleed', 'El usuario para nosebleed'))
                .setRequired(true))
        .setContexts(0, 1, 2),
