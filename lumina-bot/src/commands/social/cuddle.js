...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the cuddle action!')
        .setDescriptionLocalizations(loc('Realize a ação cuddle!', '¡Realiza la acción cuddle!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to cuddle')
                .setDescriptionLocalizations(loc('O usuário para cuddle', 'El usuario para cuddle'))
                .setRequired(true))
        .setContexts(0, 1, 2),
    ...
    async execute(interaction, t) {
        ...
        const result = await axios.get('https://api.otakugifs.xyz/gif?reaction=cuddle&format=gif');
