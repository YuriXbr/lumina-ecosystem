...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the stare action!')
        .setDescriptionLocalizations(loc('Realize a ação stare!', '¡Realiza la acción stare!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to stare')
                .setDescriptionLocalizations(loc('O usuário para stare', 'El usuario para stare'))
                .setRequired(true))
        .setContexts(0, 1, 2),
