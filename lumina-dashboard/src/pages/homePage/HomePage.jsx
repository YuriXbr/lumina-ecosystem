...
export default function HomePage() {
  const features = [
    {
      ...
      description: "Consulte perfis, histórico de partidas, maestria de campeões e rotação gratuita",
      icon: "🎮",
      commands: ["/leagueprofile", "/leaguematchhistory", "/leaguemastery", "/leaguechampionrotation", "/leaguequeuesearch"]
    },
    {
      title: "Moderação Avançada",
      description: "Sistema completo de moderação com mute, ban, warn e configurações personalizáveis",
      icon: "🛡️",
      commands: ["/ban", "/mute", "/warn", "/setuproles", "/serversettings"]
    },
    {
      title: "Sistema de Skins",
      description: "Abra baús, colete skins e gerencie seu inventário virtual do League of Legends",
      icon: "💎",
      commands: ["/openchest", "/inventory"]
    },
    {
      title: "Utilidades",
      description: "Comandos úteis para informações do servidor, usuários e sistema de ajuda",
      icon: "🔧",
  ...
  const stats = [
    { number: "15+", label: "Comandos" },
    { number: "4", label: "Categorias" },
    { number: "24/7", label: "Online" },
    { number: "Beta", label: "Versão" }
  ]
            ...
            <div className="text-center">
              <div className="mb-8 flex justify-center">
                <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-2 ring-indigo-600/20 hover:ring-indigo-600/30 bg-white/50 backdrop-blur-sm">
                  🚀 Atualmente em BETA - Novas features chegando!{' '}
                  <a href="https://github.com/YuriXbr" className="font-semibold text-indigo-600">
              ...
              <p className="mt-6 text-xl leading-8 text-gray-600 max-w-3xl mx-auto">
                O bot Discord definitivo para jogadores de League of Legends. 
                Consulte estatísticas, modere seu servidor e divirta-se com nosso sistema de skins.
              </p>
            ...
            <div className="mx-auto max-w-2xl lg:max-w-none">
              <div className="text-center">
                ...
                <p className="mt-4 text-lg leading-8 text-gray-600">
                  Lumina está em constante desenvolvimento para oferecer a melhor experiência
                </p>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Descubra todas as capacidades do Lumina Bot para melhorar sua experiência no Discord
              </p>
            </div>
                ...
                {features.map((feature) => (
                  <div key={feature.title} className="flex flex-col bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      ...
                      <div className="mt-6">
                        <p className="text-sm font-semibold text-indigo-600 mb-2">Comandos principais:</p>
          ...
          <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-indigo-200">
                Adicione o Lumina ao seu servidor Discord e comece a explorar todas as funcionalidades incríveis que oferecemos.
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href={`https://discord.com/oauth2/authorize?client_id=${import.meta.env.VITE_DISCORD_CLIENT_ID}&permissions=8&scope=bot+applications.commands`}
