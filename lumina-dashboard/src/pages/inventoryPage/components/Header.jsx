                ...
                <div className="flex flex-col sm:flex-row gap-3 min-w-0">
                    ...
                    {isDiscordLinked ? (
                        ...
                        >
                            ...
                            <span className="font-medium">{t("inventory.connectDiscord")}</span>
                        </button>
                    ) : !isLoggedIn ? (
                        <a
                            href="/login"
                    ...
                    {isDiscordLinked && (
                        ...
                        >
                            <span>🗝️</span>
                            <span>{t("inventory.openChest.title")}</span>
                        </button>
                    )}
                    ...
                    <div className="flex items-center space-x-2">
                        <input
                            type="text"
                            id="userId"
                            placeholder={t("inventory.userIdPlaceholder")}
                        ...
                        <button
                            ...
                            title={t("inventory.userIdPlaceholder")}
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg>
