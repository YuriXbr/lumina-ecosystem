...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the poke action!')
        .setDescriptionLocalizations(loc('Realize a ação poke!', '¡Realiza la acción poke!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to poke')
                .setDescriptionLocalizations(loc('O usuário para poke', 'El usuario para poke'))
                .setRequired(true))
        .setContexts(0, 1, 2),
    ...
    async execute(interaction, t) {
        ...
        const result = await axios.get('https://api.otakugifs.xyz/gif?reaction=poke&format=gif');
