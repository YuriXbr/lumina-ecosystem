...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName(actionName)
        .setDescription('Perform the slap action!')
        .setDescriptionLocalizations(loc('Realize a ação slap!', '¡Realiza la acción slap!'))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('The user to slap')
                .setDescriptionLocalizations(loc('O usuário para slap', 'El usuario para slap'))
                .setRequired(true))
        .setContexts(0, 1, 2),
